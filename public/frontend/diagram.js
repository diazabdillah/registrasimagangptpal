...
! function (t) {
    ...
    var r = n(20);
    e.el = r.defineElement, e.sv = r.defineSvgElement, e.view = r.defineView, e.create = r.createView, e.inject = r.injectView, e.disableHelp = function () {
    ...
    var r, i = n(7);
    e.DataEvents = i.DataEvents, e.DragBehaviour = i.DragBehaviour, e.DragMode = i.DragMode, (r = e.TreeFilterType || (e.TreeFilterType = {}))[r.all = 1] = "all", r[r.specific = 2] = "specific", r[r.leafs = 3] = "leafs"
}, function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", {
        value: !0
            ...
            for (var i = t(r), o = r.target; o;) {
                ...
                if (s.length)
                    for (var a = s.split(" "), l = 0; l < n.length; l++)
                        if (a.indexOf(n[l]) > -1) return e[n[l]](r, i);
                o = o.parentNode
            }
            return !0
        }
    ...
    e.getScrollbarWidth = function () {
        ...
        if ("bottom" === e) return {
            position: "absolute",
            left: l = window.innerWidth < t.left + n ? i - n : t.left,
            top: a = o + r > window.innerHeight ? t.top - r + window.scrollY : o + window.scrollY,
            minWidth: n
        };
        var s = void 0,
            a = t.top + window.scrollY,
            l = window.innerWidth < i + n ? t.left - n : i;
        return o + r > window.innerHeight && (o - r > 0 ? a = o - r + window.scrollY : (s = "scroll", r = .8 * (window.innerHeight - t.top))), {
            position: "absolute",
            left: l,
            top: a,
            minWidth: n,
    ...
    var r = function () {
        ...
        return t.prototype.load = function () {
            ...
            return void 0 === n && (n = "GET"), new Promise(function (r, i) {
                var o = new XMLHttpRequest;
                switch (o.onload = function () {
                    o.status >= 200 && o.status < 300 ? r(o.response || o.responseText) : i({
                        status: o.status,
                ...
                }, o.open(n, t), o.setRequestHeader("Content-Type", "application/json"), n) {
                    case "POST":
                    case "DELETE":
                    case "PUT":
    ...
    var o = n(0),
        ...
        l = function (t) {
            ...
            return i(e, t), e.prototype.toSVG = function () {
                var t = this.config,
                    e = this.getCenter(),
    ...
    function o(t, e, n, i, o, s) {
        ...
        return n.x === o.x && (f.y += s * d, p.x -= s * c, v = {
            x1: o.x,
            y1: o.y,
            x: o.x + s * c,
            y: o.y
        }), n.y === o.y && (f.x += s * h, p.y -= s * u, v = {
            x1: o.x,
            y1: o.y,
            x: o.x,
            y: o.y + s * u
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        if (e && n) {
            var s = function (t, e, n, r, s, a) {
                ...
                for (var l, c, u, h, d, f, p, v, g = i(e, 0, s), _ = i(n, 0, a), y = i(e, r, s), m = i(n, r, a), x = 1 / 0, b = 0; b < y.length; b++)
                    for (var w = y[b], D = 0; D < m.length; D++) {
                        ...
                        if (x > k)
                            if (x = k, w.x === C.x || w.y === C.y) g[b].x === w.x && w.x === _[D].x || g[b].y === w.y && _[D].y === w.y ? l = [g[b], _[D]] : (l = [g[b], w, C, _[D]], t.cornersRadius && "straight" !== t.connectType && (l = o(g[b], _[D], w, C, null, t.cornersRadius)));
                            else {
                                ...
                                E = S ? {
                                    x: C.x,
                                    y: w.y
                                } : E, "curved" === t.connectType ? (c = g[b], u = _[D], l = [c, {
                                    x1: (h = E).x,
                                    y1: h.y,
                                    x: u.x,
                                    y: u.y
            ...
            if (t.points) {
                if (t.points.length === s.length) t.points = t.points.map(function (t, e) {
        ...
        } else l = Math.round(i + e.width / 2), c = o + e.height, u = Math.round(s + n.width / 2), h = a, d = Math.round(r.margin.itemY / 2) + .5, t.points = [{
            x: l,
            y: c
        }, {
            x: l,
        ...
        h = function () {
            function t(t, e) {
                this._order = [], this._pull = {}, this._changes = {
                    order: []
                }, this._initOrder = null, this.config = t || {}, this._sort = new s.Sort, this._loader = new o.Loader(this, this._changes), this.events = e || new i.EventSystem(this)
            }
            return t.prototype.add = function (t, e) {
                ...
                if (r) {
                    ...
                    e.id && t !== e.id ? (l.dhxWarning("this method doesn't allow change id"), l.isDebug()) : (u.extend(this._pull[t], e), this.config.update && this.config.update(this._pull[t]), n || this._onChange("update", t, this._pull[t]))
                ...
                var o = u.uid();
                return n ? i ? void n.add(r({}, this.getItem(t)), e, i) : n.exists(t) ? (n.add(r({}, this.getItem(t), {
                    id: o
                }), e), o) : (n.add(this.getItem(t), e), t) : (this.add(r({}, this.getItem(t), {
                    id: o
                }), e), o)
                ...
                this.config.init && (t = this.config.init(t)), t.id = t.id ? t.id.toString() : u.uid(), this._pull[t.id] && l.dhxError("Item already exist"), this._initOrder && this._initOrder.length && this._addToOrder(this._initOrder, t, e), this._addToOrder(this._order, t, e)
    ...
    var d = function (t) {
        function e(e, n) {
            var r, i = t.call(this, e, n) || this,
                o = i._root = "_ROOT_" + s.uid();
            return i._childs = ((r = {})[o] = [], r), i._initChilds = null, i
        }
        return i(e, t), e.prototype.add = function (e, n, r) {
            ...
            return l.parent = i, this._childs[s].length || delete this._childs[s], this.haveChilds(i) || (this._childs[i] = []), -1 === n ? n = this._childs[i].push(l) : this._childs[i].splice(n, 0, l), this.events.fire(u.DataEvents.change), t
        }, e.prototype.eachChild = function (t, e, n) {
            if (void 0 === n && (n = !0), this.haveChilds(t))
                for (var r = 0; r < this._childs[t].length; r++) e.call(this, this._childs[t][r], r), n && this.eachChild(this._childs[t][r].id, e, n)
            ...
            for (var n = 0, r = t; n < r.length; n++) {
                var i = r[n];
                this.config.init && (i = this.config.init(i)), i.id = i.id ? i.id.toString() : s.uid(), i.parent = i.parent ? i.parent.toString() : e, this._pull[i.id] = i, this._childs[i.parent] || (this._childs[i.parent] = []), this._childs[i.parent].push(i), i.childs && i.childs instanceof Object && this._parse_data(i.childs, i.id)
            }
    ...
    o.i18n = o.i18n || {}, o.i18n.setLocale = function (t, e) {
        var n = o.i18n[t];
        for (var r in e) n[r] = e[r]
    }, o.i18n.diagram = o.i18n.diagram || i.default, window.dhx.Diagram = r.Diagram
    ...
    var o = n(3),
        ...
        y = function (t) {
            ...
            return i(e, t), e.prototype.locate = function (t) {
                ...
                var d = null;
                return this.config.$svg && (d = this.config.$svg(n)), a.el(".dhx_diagram.dhx_widget", this._htmlevents, [a.el(".dhx_wrapper", {
                    class: s
                }, [a.sv("svg", {
                    xmlns: "http://www.w3.org/2000/svg",
                    width: l,
                    height: c,
                    viewBox: n.left + " " + n.top + " " + i + " " + o
                ...
                this._htmlevents = {
                    ...
                    onmousedown: l.eventHandler(function (e) {
                        return t.locate(e)
                    }, {
                    ...
                    onmouseover: l.eventHandler(function (e) {
                        return t.locate(e)
                    }, {
                        dhx_diagram_item: function (e, n) {
                    ...
                    onclick: l.eventHandler(function (e) {
                        return t.locate(e)
                    }, {
                    ...
                    ondblclick: l.eventHandler(function (e) {
                        return t.locate(e)
                    }, {
                        dhx_diagram_connector: function (e, n) {
                ...
                this.config = s.extend({
                    ...
                    gridStep: 10
                }, this.config), window.SVGForeignObjectElement || (this.config.defaultShapeType = "svg-card")
            }, e.prototype._init_struct = function () {
                var t = this;
                this.events = new o.EventSystem(this), this.shapes = p.shapes, this.data = new v.ShapesCollection({
                    init: function (e) {
                ...
                }, this.events), this.selection = new f.Selection({}, this.data, this.events), this.export = new u.Exporter("diagram", this.version, this), this.data.events.on(_.DataEvents.change, function () {
                    return t.paint()
    ...
    r = function () {
            ...
            var s = function (t) {
                ...
                if (null == o)
                    for (E[t] = o = {
                            ...
                            attrs: null
                        }; i = O.exec(t);) null == o.attrs && (o.attrs = {}), o.attrs[i[1]] = i[2] || "";
                return o
            }(e);
            if (o.tag = s.tag, s.id || s.class || s.attrs) {
                var a = o.attrs || {};
                if (s.id && !u(a.id) && (a.id = s.id), s.class && (o._class = s.class, a.class = s.class + (u(a.class) ? " " + a.class : "")), s.attrs)
                    for (var l in s.attrs) u(a[l]) || (a[l] = s.attrs[l]);
                o.attrs = a
            }
            var c = o.attrs;
            return u(c) && (u(c._key) && (o.key = c._key), u(c._ref) && (o.ref = c._ref), u(c._hooks) && (o.hooks = c._hooks), u(c._data) && (o.data = c._data), u(c._flags) && (o.flags = c._flags), u(o.key) || (u(o.ref) ? o.key = o.ref : u(c.id) ? o.key = c.id : u(c.name) && (o.key = c.name + ("radio" === c.type || "checkbox" === c.type ? c.value : "")))), null != r && (o.body = r), o
        }

        function L(t, n, o, s) {
            if (t.type !== i && t.type !== r) {
                var a, l, u;
                t.parent = n, t.idx = o, t.vm = s, null != t.ref && (a = C(t), l = t.ref, u = t, function (t, e, n) {
                    for (var r; r = e.shift();) 0 === e.length ? t[r] = n : t[r] = t = t[r] || {}
                }(a, ["refs"].concat(l.split(".")), u));
                var h = t.hooks,
                    d = s && s.hooks;
                (h && (h.willRemove || h.didRemove) || d && (d.willUnmount || d.didUnmount)) && function (t) {
                    for (; t = t.parent;) t.flags |= P
                }(t), c(t.body) && function (t) {
                    for (var n = t.body, r = 0; r < n.length; r++) {
                        var i = n[r];
                        !1 === i || null == i ? n.splice(r--, 1) : c(i) ? (s = i, a = r--, l = 1, (o = n).splice.apply(o, [a, l].concat(s))) : (null == i.type && (n[r] = i = S("" + i)), i.type === e ? null == i.body || "" === i.body ? n.splice(r--, 1) : r > 0 && n[r - 1].type === e ? (n[r - 1].body += i.body, n.splice(r--, 1)) : L(i, t, r, null) : L(i, t, r, null))
                    }
                    var o, s, a, l
                }(t)
            }
        ...
        function R(t, e) {
            ...
            if (null == i || d(i)) t.el.style.cssText = i;
                ...
                if (o)
                    for (var c in o) null == i[c] && (t.el.style[c] = "")
            }
        }
        var N = [];
        ...
        function $(t) {
            var e;
            if (N.length)
                for (b(t.node); e = N.shift();) e[0](e[1], e[2])
        }
        ...
        function W(t, e, n) {
            ...
            if (c(r.body))
                if ((r.flags & P) === P)
                    for (var o = 0; o < r.body.length; o++) W(e, r.body[o].el);
                else G(r);
        ...
        function z(t, e) {
            ...
            if (!n._dead) {
                var r, i, o, s, a = function t(e) {
                    ...
                    if ((e.flags & P) === P && c(e.body))
                        for (var o = 0; o < e.body.length; o++) t(e.body[o]);
                    return r || i
                }(n);
                null != a && ("object" == typeof (s = a) && f(s.then)) ? (n._dead = !0, a.then((r = W, i = [t, e, !0], function () {
                    return r.apply(o, i)
                }))) : W(t, e)
            }
        }
            ...
            if (u === h);
                ...
                for (var d in u) {
                    var f = u[d],
                        p = D(t.tag, d),
                        v = p ? t.el[d] : h[d];
                    f === v || ("style" === d ? R(t, e) : x(d) || (m(d) ? tt(t, d, f, v) : (i = d, o = f, s = p, l = n, c = void 0, c = (r = t).el, null == o ? !l && et(r, i, !1) : null != r.ns ? c.setAttribute(i, o) : "class" === i ? c.className = o : "id" === i || "boolean" == typeof o || s ? c[i] = o : "." === i[0] ? c[i.substr(1)] = o : c.setAttribute(i, o))))
                }
        ...
        var ut = lt(B, function (t, e) {
                return e[t.idx + 1]
            }, Y, "lftSib", "lftNode", "rgtSib", "rgtNode", U),
            ht = lt(function (t) {
                return t.previousSibling
            }, function (t, e) {
                return e[t.idx - 1]
            }, U, "rgtSib", "rgtNode", "lftSib", "lftNode", Y);
        ...
        function _t(o, s) {
            ...
            if (l._node = o, o.type !== e || h === u) {
                ...
                d ? f || p ? function (e, o) {
                    ...
                    for (var y = 0; y < l; y++) {
                        if (h) {
                            var S = !1,
                                E = null;
                            v && (f && (k.key = s.key(y)), m = g(k, c, C)), null != m ? (x = m.idx, !0 === (E = s.diff(y, m)) ? ((O = m).parent = e, O.idx = y, O._lis = !1) : S = !0) : S = !0, S && (L(O = s.tpl(y), e, y), O._diff = null != E ? E : s.diff(y), null != m && _t(O, m)), M[y] = O
                        } else {
                            var O = s[y],
                                P = O.type;
                        ...
                        if (!f && null != m && (x === C ? ++C === u && l > u && (m = null, v = !1) : D = !0, u > 100 && D && ++b % 10 == 0))
                            for (; C < u && ft(c[C]);) C++
                    }
                    h && (e.body = M);
                    p && function (t, e) {
                ...
                }(o, s) : h !== u && (null != h ? l.textContent = h : Z(s)) : f ? (Z(s), it(o)) : h !== u && (l.firstChild ? l.firstChild.nodeValue = h : l.textContent = h), V(s.hooks, "didRecycle", s, o)
            } else l.nodeValue = h
        }
        ...
        function yt(t, e, n, r) {
            ...
            f(o) ? i.render = o : (i.render = o.render, i.config(o)), i._redrawAsync = y(function (t) {
                return i.redraw(!0)
        ...
        var mt = yt.prototype = {
            ...
            mount: function (t, e) {
                ...
                e ? (Z({
                    el: t,
                    flags: 0
                }), n._redraw(null, null, !1), t.nodeName.toLowerCase() !== n.node.tag ? (ot(n.node), Y(t.parentNode, n.node.el, t), t.parentNode.removeChild(t)) : Y(t.parentNode, ot(n.node, t), t)) : (n._redraw(null, null), t && Y(t, n.node.el));
                t && $(n);
                return n
            },
            unmount: function (t) {
        ...
        return M.patch = function (t, e) {
            ...
            q[t] && q[t].apply(e, r)
        }, mt.onemit = null, mt.body = function () {
        ...
        }, kt.defineElementSpread = Mt, kt.defineSvgElementSpread = function () {
    ...
    var r = n(27),
        ...
        a = n(30),
        l = n(31);
    for (var c in e.shapes = {
            line: r.Line,
            dash: r.Line,
            card: i.DiagramCard,
            "img-card": o.DiagramImgCard,
            "svg-card": s.DiagramSvgCard,
            text: l.TextShape
        }, a.renders) e.shapes[c] = a.FlowShape;
    ...
    var s = n(0),
        a = function (t) {
            ...
            return i(e, t), e.prototype.isConnector = function () {
                return !0
            }, e.prototype.getMetaInfo = function () {
                return [{
                    id: "strokeProps",
    ...
    var o = n(0),
        s = function (t) {
            ...
            return i(e, t), e.prototype.getMetaInfo = function () {
                return [{
                    id: "title",
                    label: "Title",
                    type: "text"
                ...
                return [o.el("div", {
                    ...
                    style: "background-image:url(" + (t.img || "") + ");background-color:" + t.color + ";"
                }), o.el("div", {
        ...
        l = function (t) {
            ...
            return i(e, t), e.prototype.toSVG = function () {
                ...
                return o.sv("g", {
                    ...
                    class: "dhx_content_title"
                }, [t.title || ""]) : null, o.sv("tspan", {
                    class: "dhx_content_text",
                    x: t.width / 2,
                    dy: t.title ? "1.5em" : ".5em"
                }, [t.text || ""])]), a.getHeaderTpl(t), a.getCircleTpl(t)])
            }, e.prototype.getMetaInfo = function () {
                return [{
                    id: "title",
                    label: "Title",
    ...
    var o = n(0),
        s = function (t) {
            ...
            return i(n, t), n.prototype.getMetaInfo = function () {
                return [{
                    id: "fill",
                    type: "color",
                    label: "Fill",
                ...
                return t.width = t.width || (e ? 90 : 140), t.height = t.height || 90, t.stroke = t.stroke || "#DEDEDE", t.extraLinesStroke = t.extraLinesStroke || "#FFF", t.fill = t.fill || "#DEDEDE", t.strokeWidth = t.strokeWidth || 1, t.fontColor = t.fontColor || "#4C4C4C", t.fontSize = t.fontSize || 14, t.textAlign = t.textAlign || "center", t.lineHeight = t.lineHeight || 14, t.fontStyle = t.fontStyle || "normal", t.textVerticalAlign = t.textVerticalAlign || "center", t
    ...
    e.FlowShape = s, e.extraLines = {
        database: function (t, e, n, r) {
            return o.sv("path", {
                d: "M 0 " + n + " A " + t / 2 + "," + n + " 0 1 0 " + t + "," + n,
                fill: "none",
    ...
    var o = n(33),
        ...
        a = function (t) {
            function e(e, n) {
                var r = t.call(this, e, n) || this;
                return r._roots = [], r._orgMode = "org" === e.type, r.events.on(s.DataEvents.change, function (t, e, n) {
            ...
            return i(e, t), e.prototype.getNearId = function (t) {
                var e = this._pull[t];
    ...
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), r(n(1)), r(n(13)), r(n(16)), r(n(36)), r(n(9)), r(n(2)), r(n(14)), r(n(15)), r(n(38))
}, function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", {
        value: !0
        ...
        i = function () {
            ...
            return t.prototype.load = function (t, e) {
                ...
                for (var e = this, n = function (n) {
                    ...
                    }, i = this, o = 0, s = this._changes.order; o < s.length; o++) {
                    n(s[o])
                }
    ...
    var h = function () {
        function t() {
            var t = this;
            this._transferData = {}, this._canMove = !0, this._ghostTopPadding = -17, document.addEventListener("mousemove", function (e) {
        ...
        return t.prototype.setItem = function (t, e, n) {
            ...
            var o, l, u = (o = i, (l = document.createElement("div")).textContent = o.value || o.text, l.className = "drag-ghost", l);
            ...
            var e = t.x,
                ...
                h = o.locate(i, "dhx_id");
            if (h) {
                var d, f, p = o.locate(i, "dhx_collection_id");
                if (this._transferData.dragConfig.behaviour === c.DragBehaviour.complex) {
                    var v = u(t);
                    this._transferData.dropPosition = v <= .25 ? r.top : v >= .75 ? r.bot : r.in
                ...
                if (h && p || !this._canMove)
                    if (d = [f = {
                            ...
                            id: h,
                            target: a.collectionStore.getItem(p)
                        }], f.target.events.fire(s.DragEvents.dragOut, d), p !== this._transferData.targetId || !(f.target.data instanceof l.TreeCollection) || f.target.data instanceof l.TreeCollection && f.target.data.canCopy(f.id, h)) this._cancelCanDrop(), this._lastId = h, this._lastCollectionId = p, f.target.events.fire(s.DragEvents.dragIn, d) && this._canDrop();
            ...
            this._toggleTextSelection(!1), this._transferData.target && this._transferData.target.events.fire(s.DragEvents.dragEnd), this._cancelCanDrop(), this._canMove = !0, this._transferData = {}, this._lastId = null, this._lastCollectionId = null
    ...
    var r = n(3),
        ...
        s = function () {
            function t(t, e, n) {
                var i = this;
                this.events = n || new r.EventSystem, this._data = e, this._data.events.on(o.DataEvents.removeAll, function () {
                    i._selected = null
