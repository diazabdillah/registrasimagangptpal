...
class ForumController extends Controller
{
    ...
    public function index()
    {
        ...
        $ti = 'Chat Admin';
        $forum = Forum::orderBy('created_at', 'desc')->paginate(5);
    ...
    public function view_forum($id)
    {
        ...
        $ti = 'Forum Diskusi';
        $komentar = Komentar::orderBy('created_at', 'desc')->where('forum_id', '=', $id)->paginate(5);
        $forum = Forum::orderBy('created_at', 'desc')->where('id', '=', $id)->paginate(5);
