        ...
        <div class="col-lg">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-primary btn-sm mb-3" href="/cetakRekapSmkPDF" target="_blank" role="button"><i
                            class="fas fa-file-export"></i> Export PDF</a>
                    <a class="btn btn-success btn-sm mb-3" href="/cetakRekapSmkEXCEL" target="_blank" role="button"><i
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-danger" href="delete-rekap-smk/{{$rekap->id}}">Delete</a>
                                        </td>
                                    </tr>
                                    @endif
                                    @endforeach
