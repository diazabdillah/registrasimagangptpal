        ...
        <div class="col-lg">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-primary btn-sm mb-3" href="/cetakRekapSmkPDFdivisi" target="_blank" role="button"><i
                            class="fas fa-file-export"></i> Export PDF</a>
                    {{-- <a class="btn btn-success btn-sm mb-3" href="/cetakRekapSmkEXCELdivisi" target="_blank" role="button"><i
