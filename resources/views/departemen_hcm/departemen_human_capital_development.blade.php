        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="main-title on-dark text-center">
                    ...
                    <h3>Departemen Human Capital Development</h3>
                </div>
    ...
    <div class="container-fluid">
        <div class="row enter bottom move 40px over 0.8s after 0.2s" style="padding-right: 1%">
            <div class="col text-center">
                <h3>TUGAS POKOK DEPARTEMEN HUMAN CAPITAL DEVELOPMENT</h3> <br>
                <div class="col text-left">
                    <ol style="font-size:1vw">
                        <li>
                            <p>Menjabarkan, menyusun strategi pelaksanaan kebijakan Divisi HCM & Command Media beserta program kerjanya dalam bidang pendidikan dan pelatihan, uji kompetensi dan sertifikasi baik untuk internal perusahaan maupun eksternal, perencanaan pengembangan kompetensi dan analisa jabatan serta mengelola aset.</p>
                        </li>
                        <li>
    ...
    <div class="container">
        <div class="row enter bottom move 40px over 0.8s after 0.2s" style="padding-right: 1%">
            <div class="col text-center">
                ...
                <img style="width: 80%;" src="{{URL::asset('frontend')}}/img/profile/hcd.jfif" class="rounded float-center animate__animated animate__bounce" alt="...">
            </div>
        </div><br>
    </div>
</div>
    ...
    <div class="container-fluid">
        <div class="row enter bottom move 40px over 0.8s after 0.2s">
            <div class="col text-center"><br>
                ...
                <img style="width: 90%;" src="{{URL::asset('frontend')}}/img/profile/Bagan-Dep. HCD.png" class="rounded float-center animate__animated animate__bounce" alt="...">
            </div>
        </div>
    </div>
</div>
