        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="main-title on-dark text-center">
                    ...
                    <h3>Departemen Organizational Development & Command Media</h3>
                </div>
                <h5 style="color: rgb(208, 208, 208)">
                    ...
                    Departemen Organizational Development & Command Media
                </h5>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row enter bottom move 40px over 0.8s after 0.2s" style="padding-right: 1%">
            <div class="col text-center">
                <h3>TUGAS POKOK DEPARTEMEN ORGANIZATIONAL DEVELOPMENT & COMMAND MEDIA</h3> <br>
                <div class="col text-left">
                    <ol style="font-size:1vw">
                        <li>
                            <p>Menjabarkan, menyusun strategi pelaksanaan kebijakan Divisi HCM & Command Media beserta program kerjanya dalam bidang perencanaan & pengembangan organisasi, analisa jabatan, MPP dan pengelolaan Command Media, Bisnis proses level 2 (Catatan : Bisnis Proses level 1 di PSP).</p>
                        </li>
                        <li>
    ...
    <div class="container">
        <div class="row enter bottom move 40px over 0.8s after 0.2s" style="padding-right: 1%">
            <div class="col text-center">
                ...
                <img style="width: 80%;" src="{{URL::asset('frontend')}}/img/profile/odcm.jfif" class="rounded float-center animate__animated animate__bounce" alt="...">
            </div>
        </div><br>
    </div>
</div>
    ...
    <div class="container-fluid">
        <div class="row enter bottom move 40px over 0.8s after 0.2s">
            <div class="col text-center"><br>
                ...
                <img style="width: 90%;" src="{{URL::asset('frontend')}}/img/profile/Bagan-Dep. ODCM.png" class="rounded float-center animate__animated animate__bounce" alt="...">
            </div>
        </div>
    </div>
</div>
