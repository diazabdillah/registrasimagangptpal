                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-info" role="alert">
                                <h5>Langkah 1 :</h5>
                                <p class="card-text"><b>Klik "Isi Data"</b><br> Jika sudah mengisi data pada form, maka
                                    data Anda akan tampil pada table dibawah.</p>
                                {{-- @if ($data[0]->nama == null) --}}

                                <a href="/input-data-mhs" class="btn btn-primary mb-3 mr-2">Isi Data <i
                            ...
                            <div class="alert alert-primary" role="alert">
                                <h5>Langkah 2 :</h5>
                                <p class="card-text"><b>Klik "Upload Berkas"</b><br>Jika sudah upload berkas pada form,
                                    maka berkas Anda akan tampil pada table dibawah.</p>

                                <a href="/berkas-mhs" class="btn btn-success mb-3">Upload Berkas <i
                            ...
                            <div class="table-responsive table-hover">
                                <a class="btn btn-danger mt-3 mb-3" href="/berkas-mhs-semua"><i
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a class="btn btn-primary p-1" target="_blank"
                                                        href="{{ asset('file/berkas-mahasiswa/' . $file->user_id . '/' . $file->path) }}"><i
                                                            class="fa fa-download"></i> Download</a>
                                                    <a class="btn btn-danger p-1"
                                                        href="{{ url('berkas-mhs/' . $file->id, $file->path) }}"
