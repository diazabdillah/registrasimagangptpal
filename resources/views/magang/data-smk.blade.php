                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-info" role="alert">
                                ...
                                <a href="/input-data-smk" class="btn btn-primary mb-3 mr-2">Isi Data <i
                            ...
                            <div class="alert alert-primary" role="alert">
                                ...
                                <a href="/berkas-smk" class="btn btn-success mb-3">Upload Berkas <i
                            ...
                            <div class="table-responsive table-hover">
                                <a class="btn btn-danger mt-3 mb-3" href="/berkas-smk-semua"><i
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a class="btn btn-primary p-1"
                                                        href="{{ asset('file/berkas-smk/' . $file->user_id . '/' . $file->path) }}"><i
                                                            class="fa fa-download"></i> Download</a>
                                                    <a class="btn btn-danger p-1"
                                                        href="/berkas-smk/{{ $file->id }}/{{ $file->path }}"
