                                            ...
                                            @if ($users[0]->status_user == 'Mahasiswa')
                                                ...
                                                @if ($img->fotoID != null)
                                                    <tr>
                                                        <td>{{ $img->nama }}</td>
                                                        <td>
                                                            <img src="{{ asset('file/foto-mhs/' . $img->id_individu . '/' . $img->fotoID) }}"
                                                                alt="Foto" class="img-thumbnail" width="135">
                                                        </td>
                                                        <td>
                                                            <a class="btn btn-danger"
                                                                onclick="return confirm('yakin Hapus?');"
                                                                href="/dokumen-mhs-foto/{{ $img->id }}/{{ $img->fotoID }}">Hapus</a>
                                                        </td>
                                            ...
                                            @else
                                                ...
                                                @if ($img->fotoID != null)
                                                    <tr>
                                                        <td>{{ $img->nama }}</td>
                                                        <td>
                                                            <img src="{{ asset('file/foto-mhs-kel/' . $img->id_individu . '/' . $img->fotoID) }}"
                                                                alt="Foto" class="img-thumbnail" width="135">
                                                        </td>
                                                        <td>
                                                            <a class="btn btn-danger"
                                                                onclick="return confirm('yakin Hapus?');"
                                                                href="/dokumen-mhs-kel-foto/{{ $img->id }}/{{ $img->fotoID }}">Hapus</a>
                                                        </td>
                                            ...
                                            @if ($users[0]->status_user == 'Mahasiswa')
                                                ...
                                                @if ($img1->foto != null)
                                                    ...
                                                    <tr>
                                                        <td>{{ $img1->nama }}</td>
                                                        <td>
                                                            <img src="{{ asset('file/dokumen-mhs/' . $img1->id_individu . '/' . $img1->foto) }}"
                                                                alt="Foto" class="img-thumbnail" width="135">
                                                        </td>
                                                        <td>
                                                            <a class="btn btn-danger"
                                                                onclick="return confirm('yakin Hapus?');"
                                                                href="/dokumen-mhs/{{ $img1->id }}/{{ $img1->foto }}">Hapus</a>
                                                        </td>
                                                    </tr>
                                            ...
                                            @else
                                                ...
                                                @if ($img1->foto != null)
                                                    ...
                                                    <tr>
                                                        <td>{{ $img1->nama }}</td>
                                                        <td>
                                                            <img src="{{ asset('file/dokumen-mhs-kel/' . $img1->id_individu . '/' . $img1->foto) }}"
                                                                alt="Foto" class="img-thumbnail" width="135">
                                                        </td>
                                                        <td>
                                                            <a class="btn btn-danger"
                                                                onclick="return confirm('yakin Hapus?');"
                                                                href="/dokumen-mhs-kel/{{ $img1->id }}/{{ $img1->foto }}">Hapus</a>
                                                        </td>
                                                    </tr>
