                        ...
                        <div class="col-lg">
                            ...
                            <div class="alert alert-info" role="alert">
                                <p class="card-text">
                                    ...
                                    - Absen Datang dibuka pukul 06.00 - 12.00 (<b> Absen Datang diperbolehkan ketika
                                        para praktikan sudah di dalam area PT PAL </b>)</b> <br>
                                    - Absen Pulang dibuka pukul 16:30 - 19.30 <br>
                                    - Absen izin dibuka pukul 06:00 - 16:30 <br> (Absen Izin Jika Para Praktikan <b>
                                        Sakit </b>, Selain
                                    Itu
                                    <b>Tidak Boleh, Harus Konfirmasi ke Pembimbing Magang Melalui Whatsapp Apabila
                                        Hendak Izin Ada
                                        Keperluan
                                        Lain</b>).
                                </p>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered mt-4" id="dataTable" width="100%"
                                            cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Nama</th>
                                            ...
                                            <tbody>
                                                @foreach ($absensmk as $as)
                                                    @if ($as->status_user == 'SMK Kelompok')
                                                        <tr>
                                                            <th>{{ $as->nama }}</th>
                                                            <th>Datang</th>
                                                            @if (Carbon\Carbon::now()->between(Carbon\Carbon::parse($as->selesai), Carbon\Carbon::parse($as->mulai)))
                                                                @if (date('H:i', strtotime(now())) >= '06:00' && date('H:i', strtotime(now())) <= '12:00' && date('l', strtotime(now())) != 'Sunday' && date('l', strtotime(now())) != 'Saturday')
                                                                    <th>
                                                                        <a class="btn btn-primary p-1"
                                                                            href="/absen-datang-smk/{{ $as->id }}"
                                                                            role="button">Presensi</a>
                                                                    </th>
                                                                @else
                                                                    <th>
                                                                        <button class="btn btn-secondary"
                                                                            disabled>Presensi</button>
                                                                    </th>
                                                                @endif
                                                            @else
                                                                <th>
                                                    ...
                                                    @else
                                                        <tr>
                                                            ...
                                                            @if (Carbon\Carbon::now()->between(Carbon\Carbon::parse($as->mulai), Carbon\Carbon::parse($as->selesai)))
                                                                @if (date('H:i', strtotime(now())) >= '06:00' && date('H:i', strtotime(now())) <= '12:00' && date('l', strtotime(now())) != 'Saturday')
                                                                    <th>
                                                                        <div>
                                                                            <form class="myForm"
                                                                                id="form-prevent"
                                                                                enctype="multipart/form-data"
                                                                                action="/proses-absen-masuk-smk/{{ $as->id }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                <div class="form-group">
                                                                                    <label>Bukti Absen Masuk:</label>
                                                                                    <div id="my_camera"></div>
                                                                                    <input type=button
                                                                                        class="btn btn-sm btn-primary"
                                                                                        value="Take Snapshot"
                                                                                        onClick="take_snapshot()"
                                                                                        id="inputTopic" required>

                                                                                    <input type="hidden" id="inputTopic"
                                                                                        name="file_absen"
                                                                                        class="image-tag"
                                                                                        required>
                                                                                    <div id="results"> <small> Wajib!
                                                                                            Take Snapshot terlebih
                                                                                            dahulu Sebagai Bukti Absen
                                                                                            Masuk, Setelah ada hasil
                                                                                            fotonya tekan button
                                                                                            "presensi"</small> </div>
                                                                                </div>
                                                                                {{-- <div class="form-group">
                                                                    ...
                                                                    <th>
                                                                        <div>
                                                                            <form class="myForm"
                                                                                id="form-prevent"
                                                                                enctype="multipart/form-data"
                                                                                action="/proses-absen-pulang-smk/{{ $as->id }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                <div class="form-group">
                                                                                    <label>Bukti Absen Masuk:</label>
                                                    ...
                                                    role="button">Presensi</a> --}}
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>Izin</th>
                                                            @if (Carbon\Carbon::now()->between(Carbon\Carbon::parse($as->selesai), Carbon\Carbon::parse($as->mulai)))
                                                                @if (date('H:i', strtotime(now())) >= '06:00' && date('H:i', strtotime(now())) <= '19:30' && date('l', strtotime(now())) != 'Sunday' && date('l', strtotime(now())) != 'Saturday')
                                                                    <th>
                                                                        <div>
                                                                            <form class="my-Form"
                                                                                id="formprevent"
                                                                                enctype="multipart/form-data"
                                                                                action="/proses-absen-izin-smk/{{ $as->id }}"
                                                                                method="POST">
                                                                                @csrf

                                                                                <div class="form-group">
                                                                                    <label for="recipient-name">Bukti
                                                                                        Izin:</label>
                                                                                    <div id="mycamera"></div>
                                                                                    <input type=button
                                                                                        class="btn btn-sm btn-primary"
                                                                                    ...
                                                                                    <input type="hidden"
                                                                                        name="file_absen"
                                                                                        class="imagetag">
                                                                                    <div id="results1"> <small> Wajib!
                                                                                            Take Snapshot terlebih
                                                                                            dahulu Sebagai Bukti Absen
                                                                                            Izin, Setelah ada hasil
                                                                                            fotonya isi keterangan izin
                                                                                            dan tekan tombol
                                                                                            "Presensi"</small> </div>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label class="ml-2">Jenis
                                                                                        Izin</label>
                                                                                    <select class="form-control"
                                                                                        name="jenis_absen" id="">
                                                                                        <option value="Izin Sakit">Sakit
                                                                                        </option>
                                                                                        <option
                                                                                            value="Izin Keperluan Lain">
                                                                                            Keperluan Lain</option>
                                                                                    </select>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label
                            ...
                            <div class="card shadow mb-4">
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Rekap Absen SMK</h6>

                                    <div class="dropdown no-arrow">
                                        @if (Auth::user()->status_user == 'SMK Kelompok')
                                            @if (!empty($absensmkk[0]->id))

                                                <a class="btn btn-primary" href="/cetak-absen-smk-pdf"
                                                    target="_blank">Cetak Absen</a>
                                            @else
                                                <button class="btn btn-secondary" href="#" disabled>Cetak
                                                    Absen</button>
                                        ...
                                        <table class="table table-bordered mt-4" id="dataTable" width="100%"
                                            ...
                                            <tbody>
                                                @foreach ($absensmkk as $ass)
                                                    <tr>
                                                        <th> {{ $ass->nama }} </th>
                                                        <th>{{ date('H:i, d F Y', strtotime($ass->waktu_absen)) }}
                                                        </th>
                                                        ...
                                                        <th>
                                                            @if ($ass->file_absen != null)
                                                                <img src="{{ asset('file/absen/' . $ass->file_absen) }}"
                                                                    alt="Foto" class="img-thumbnail" width="135">
                                                            @endif
                                                        </th>
                                                        <th>{{$ass->latitude}},{{$ass->longitude}}</th>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                            ...
                            <div class="alert alert-danger" role="alert">
                                <p class="card-text">
                                    <b> Note :</b> <br>
                                    - Mohon Para Praktikan hendak absen silahkan tunggu tombol "presensi" berubah
                                    menjadi tombol biru sesuai jam yang ada di peraturan absensi tersebut. <br>
                                    - Mohon para Praktikan Absen setiap hari ketika magang anda berlangsung jika para
                                    Praktikan tidak hadir magang karena Sakit silahkan absen izin. <br>
                                    - Mohon Para Praktikan hendak absen menyalakan Kamera dan GPS terlebih dahulu. <br>
                                    - Mohon para Praktikan Kelompok tidak boleh tekan button "prensensi" punya nama
                                    temannya hanya diperbolehkan punya nama sendiri. <br>
                                    - Mohon tekan button "cetak absen" di tabel rekap absen untuk mencetak absen. <br>
                                    - Mohon Para Praktikan mengikuti peraturan absen jika melanggar/tidak jujur akan
                                    diberikan sanksi.
