    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg">
                ...
                <!-- Card -->
                <a href="/id-card-mhs-pdf" target="_blank" class="btn btn-danger mb-3"><i class="fas fa-download"></i>
                    Cetak</a>
                                    ...
                                    <div class="mt-4">
                                        <div class="d-flex justify-content-center">
                                            @if ($datas[0]->status_user == 'Mahasiswa')
                                                <img src="{{ asset('file/foto-mhs/' . $data->id_individu . '/' . $data->fotoID) }}" alt="image"
                                                    style="width: 150px; height:180px; border-radius: 5px; border: 3px white solid;">

                                            @elseif($datas[0]->status_user == "Mahasiswa Kelompok")
                                                <img src="{{ asset('file/foto-mhs-kel/' . $data->id_individu . '/' . $data->fotoID) }}" alt="image"
                                                    style="width: 150px; height:180px; border-radius: 5px; border: 3px white solid;">
