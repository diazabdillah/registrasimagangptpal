                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <div class="dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                    ...
                                    <a class="dropdown-item" target="_blank" href="/balasan-smk-cetak">Cetak Surat
                                        Balasan</a>
                            ...
                            <div class="chart-area" style="width:100%;height:100%;">
                                ...
                                <div class="justify-content-center ml-4" style="margin-top: 70px">
                                    ...
                                    <p>1. Memperhatikan Surat Nomor
                                        ...
                                        menerima
                                        Praktikan OJT/PKL dari {{ $datas[0]->sekolah }} untuk melaksanakan praktek kerja
