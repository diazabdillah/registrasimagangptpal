                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <form method="POST" action="{{ route('uploadFotoMhs') }}"
                                            enctype="multipart/form-data">
                                            @csrf

                                            @foreach ($showImage as $img)
                                                <div class="form-group">
                                                    <img src="{{ asset('/file/' . $img->foto) }}"
                    ...
                    <div class="col-sm-6">
                        <div class="card shadow mb-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <form method="POST" action="{{ route('upFotoMhs') }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                    ...
                                    @foreach ($fotoID as $imgid)
                                        <div class="col-sm-3 mb-3">
                                            <div class="card">
                                                <img src="{{ asset('/file/' . $imgid->fotoID) }}"
                                                    alt="Foto" class="img-thumbnail" width="135">
                                                <a class="btn btn-danger p-0 mt-2 float-right"
                                                    href="{{ url('Dokumen_mhs_upload/' . $imgid->id, $imgid->fotoID) }}"><i
