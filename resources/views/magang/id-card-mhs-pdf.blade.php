        ...
        @foreach ($datas as $data)
            ...
            <div style="width: 19rem;border:1px solid; border-radius:10px;">
                ...
                <div>
                    ...
                    @if ($datas[0]->status_user == 'Mahasiswa')
                        <img src="{{ public_path('file/foto-mhs/' . $data->id_individu . '/' . $data->fotoID) }}" alt="image"
                    ...
                    @elseif($datas[0]->status_user == "Mahasiswa Kelompok")
                        <img src="{{ public_path('file/foto-mhs-kel/' . $data->id_individu . '/' . $data->fotoID) }}" alt="image"
                            style="width: 150px; height:180px; border-radius: 5px;margin-top:30px;margin-left:105px;margin-bottom:20px; border: 1px black solid;">
