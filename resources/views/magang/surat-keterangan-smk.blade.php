                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <div class="dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" target="_blank" href="/surat-keterangan-smk-pdf">Cetak Surat
                                    Keterangan</a>
                    ...
                    <div class="card-body">
                        <div class="chart-area">
                            ...
                            <div style="margin-left:300px;margin-top:20px">
                                ...
                                <h6>Nama&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;: <b>{{ $sertif->nama }}</b></h6>
                                <h6>Sekolah&emsp;&emsp;&emsp;&emsp;&emsp;: {{ $sertif->sekolah }}</h6>
                            ...
                            <div style="float: right;margin-right:60px;margin-top:40px;">
                                <div>
                                    <p class="justify-content-center">Surabaya,
                                        {{ date('d-F-Y', strtotime($sertif->selesai)) }}
                                    </p>
                                </div>
