        ...
        <div class="col-lg">
            ...
            <div class="card shadow mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="/input-data-mhsInd" class="btn btn-primary mb-3 mr-2">Isi Data <i class="fas fa-pencil-alt"></i></a>
                        <a href="/berkas-mhs-indiv" class="btn btn-success mb-3">Upload File <i class="fas fa-upload"></i></a>
                        ...
                        <div class="table-responsive table-hover">
                            ...
                            <a class="btn btn-danger mt-3 mb-3" href="/openpdf"><i class="fas fa-fw fa-file-pdf mr-2"></i>Open all file</a>
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                <thead>
                                    <tr class="text-center text-white bg-primary">
                                        <th>File</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a class="btn btn-secondary p-1" href="{{ url('Data_mhs/' . $file->id, $file->path) }}">Hapus</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
