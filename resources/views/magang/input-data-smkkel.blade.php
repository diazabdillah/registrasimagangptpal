                ...
                <div class="card shadow mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('uploadsmkkel') }}">
                                @csrf
                                ...
                                <!-- Input Univ -->
                                <div class="form-group">
                                    <small class="ml-2">Sekolah Asal</small>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="alamat" name="alamat_rumah">
                                </div>
                                <div class="form-group">
                                    <small class="ml-2">Nomor Handphone</small>
