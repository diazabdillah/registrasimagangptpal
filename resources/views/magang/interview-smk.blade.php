                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if ($interview->fileinterview == null)
                                                                <a class="btn btn-warning" href="/interview-smk/{{$interview->id}}" role="button">Upload Hasil Interview</a>
                                                            @endif
                                                        ...
                                                        <td>
                                                            ...
                                                            @if ($interview->fileinterview == null)
                                                                <a class="btn btn-warning" href="/interview-smk-kel/{{$interview->id}}" role="button">Upload Hasil Interview</a>
                                                            @endif
