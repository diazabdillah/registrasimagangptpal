                        ...
                        <div class="card border-left-success shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <a class="btn btn-success mt-2" href="/lihat-kegiatan-smk/{{ $tugas->id }}">Lihat
                                            Tugas</a>
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <div class="dropdown no-arrow">
                    <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Tambah Kegiatan
                        Lainnya</a>
                    <a class="btn btn-primary" href="/cetak-kegiatan-smk-pdf" target="_blank">Cetak Laporan Kegiatan</a>
                </div>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        @if ($ams->foto_kegiatan != null)
                                            <img width="100px"
                                                src="{{ asset('file/foto-kegiatan-smk/' . $ams->foto_kegiatan) }}">
                                        @endif
                                    </th>
                              <th><a class="btn btn-danger" href="{{ url('delete-tugas-smk/' . $ams->id, $ams->foto_kegiatan) }}">Delete</a></th>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="myForm" action="tambah-kegiatan-smk" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div>
