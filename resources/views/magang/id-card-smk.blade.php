    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg">
                ...
                <!-- Card -->
                <a href="/id-card-smk-pdf" target="_blank" class="btn btn-danger mb-3"><i class="fas fa-download"></i>
                    Cetak</a>
                                    ...
                                    <div class="mt-4">
                                        <div class="d-flex justify-content-center">
                                            @if ($datas[0]->status_user == 'SMK')
                                                <img src="{{ asset('file/foto-smk/' . $data->id_individu . '/' . $data->fotoID) }}"
                                                    alt="image"
                                                    style="width: 150px; height:180px; border-radius: 5px; border: 3px white solid;">

                                            @elseif($datas[0]->status_user == "SMK Kelompok")
                                                <img src="{{ asset('file/foto-smk-kel/' . $data->id_individu . '/' . $data->fotoID) }}"
                                                    alt="image"
                                                    style="width: 150px; height:180px; border-radius: 5px; border: 3px white solid;">
