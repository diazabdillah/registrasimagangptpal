...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <!-- Card -->
            <a href="/id-card-smk-pdf" class="btn btn-danger mb-3"><i class="fas fa-download"></i> Cetak</a>
            <a href="/id-card-smk-pdf-save" class="btn btn-primary mb-3"><i class="fas fa-download"></i> Pdf</a>
                ...
                <div class="col-sm-6">
                    <div class="card" style="width: 19rem;">
                        <div class="headerIdCard bg-gradient-primary mb-5">
                            <div class="mt-4">
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <img src="{{ asset('file/foto-smk/' . $data->fotoID) }}" alt="image" style="width: 150px; height:180px; border-radius: 5px; border: 3px white solid;">
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <img src="{{ asset('file/foto-smk-kel/' . $data->fotoID) }}" alt="image" style="width: 150px; height:180px; border-radius: 5px; border: 3px white solid;">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-title text-dark mb-3"><b>Nim : </b>{{ $data->nis }}</h6>
