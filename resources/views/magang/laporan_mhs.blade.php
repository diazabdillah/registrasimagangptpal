            ...
            <div class="col-lg">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                            ...
                            <a class="btn btn-primary btn-sm mb-3" href="/upload_laporan" role="button"><i
                                    class="fas fa-plus"></i> upload laporan</a>
                                    <div class="row mt-4">
                                                ...
                                                <div class="card">
                                                    <div class="row no-gutters">
                                                        <div class="col-md-4 mb-3 mt-3 ">
                                                            <img width="115px" height="220px"
                                                                style="margin-left:5px;border-radius: 15px;border:1px solid;"
                                                                src="{{ asset('/file/' . $laporans->cover) }}" class="gambar1"
                                                                alt="pt pal">
                                                        </div>
                                                        <div class="col-md-8">
                                                            <div class="card-body">
                                                                ...
                                                                @if ($laporans->path != null)
                                                                    {{-- <a class="btn btn-primary"
                                                                        ...
                                                                        <a class="btn btn-primary"
                                                                        href="{{url('/lihat_laporan_mhs/'.$laporans->id)}}">lihat</a>
                                    ...
                                    <div class="card">
                                        <div class="row no-gutters">
                                            <div class="col-md-4 mb-3 mt-3 ">
                                                <img width="115px" height="220px"
                                                    style="margin-left:5px;border-radius: 15px;border:1px solid;"
                                                    src="{{ asset('/file/' . $laporan->cover) }}" class="gambar1"
                                                    alt="pt pal">
                                            </div>
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    ...
                                                    @if ($laporan->path != null)
                                                        {{-- <a class="btn btn-primary"
                                                            href="{{ asset('/file/' . $laporan->path) }}">Download</a> --}}
                                                            <a class="btn btn-primary"
                                                            href="{{url('/lihat_laporan_mhs/'.$laporan->id)}}">lihat</a>
