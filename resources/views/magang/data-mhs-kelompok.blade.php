                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a class="btn btn-warning p-1"
                                                        href="/edit-data-mhs-kelompok/{{ $d->id }}/{{ $d->id_rekap }}"
                                                        onclick="return confirm('yakin Edit?');"><i
                                                            class="far fa-edit"></i> Edit</a>
                                                    <a class="btn btn-danger p-1"
                                                        href="/delete-data-mhs-kelompok/{{ $d->id }}/{{ $d->id_rekap }}"
                            ...
                            <div class="alert alert-primary" role="alert">
                                ...
                                <a href="/berkas-mhs-kelompok" class="btn btn-success mb-3 mr-2">Upload File <i
                            ...
                            <div class="table-responsive table-hover">
                                <a class="btn btn-danger mt-3 mb-3" href="/berkas-mhs-kelompok-semua"><i
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a class="btn btn-primary p-1"
                                                        href="/berkas-mhs-kelompok/{{ $file->id }}"><i
                                                            class="far fa-eye"></i> Lihat</a>
                                                    <a class="btn btn-danger p-1"
                                                        href="/berkas-mhs-kelompok/{{ $file->id }}/{{ $file->path }}"
                                                        onclick="return confirm('yakin Hapus?');"><i
                                                            class="far fa-trash-alt"></i> Hapus</a>
                                                </td>
                                            </tr>
