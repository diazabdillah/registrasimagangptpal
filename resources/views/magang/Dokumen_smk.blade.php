                    ...
                    <div class="col-sm-6">
                        <div class="card shadow mb-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="/Dokumen_smk_upload" class="btn btn-primary mb-3 mr-3">Buka Form Upload <i
                                            class="fas fa-upload ml-2"></i></a>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-wrap">
                                    @foreach ($showImage as $img)
                                        <div class="col-sm-3">
                                            <div class="card">
                                                <img src="{{ asset('/storage/public/fotosmk/' . $img->foto) }}" alt="Foto"
                                                    class="img-thumbnail" width="135">
                                                <a class="btn btn-danger p-0 mt-2 float-right"
                                                    href="{{ url('Dokumen_smk/' . $img->id, $img->foto) }}"><i
