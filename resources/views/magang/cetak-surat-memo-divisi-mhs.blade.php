...
<body>
    ...
    <div class="card-body">
        ...
        <div style="font-size: 14px;" class="justify-content-center ml-4">
            <p>Dengan Hormat,</p>
            <p style="text-align:justify;">1. Sesuai koordinasi dengan Divisi di PT. PAL Indonesia (Persero) tentang kesediaan menerima Praktik Kerja Lapangan, bersama ini disampaikan data mahasiswa/mahasiswi dari {{ $datas[0]->univ }} Jurusan {{ $datas[0]->jurusan }} yang akan melaksanakan On the Job Training.
