                        ...
                        <div class="col-lg">
                            ...
                            <div class="alert alert-info" role="alert">
                                <p class="card-text">
                                    ...
                                    - Absen izin dibuka pukul 06:00 - 16:30 <br> (Absen Izin Jika Para Praktikan <b> Sakit </b>, Selain
                                    Itu,
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if (Carbon\Carbon::now()->between(Carbon\Carbon::parse($am->mulai), Carbon\Carbon::parse($am->selesai)))
                                                            @if (date('H:i', strtotime(now())) >= '06:00' && date('H:i', strtotime(now())) <= '12:00'  && date('l', strtotime(now())) != 'Saturday')
                                                                <th>
                                                                    <div>
                                                                        <form  class="myForm" id="form-prevent" enctype="multipart/form-data"
                                                                            action="/proses-absen-masuk-mhs/{{ $am->id }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type=button class="btn btn-sm btn-primary" value="Take Snapshot"
                                                                                    onClick="take_snapshot()" id="inputTopic" required>
            
                                                                                <input type="hidden" id="inputTopic" name="file_absen" class="image-tag" required>
                                                                                <div id="results"> <small> Wajib! Take Snapshot terlebih dahulu Sebagai Bukti Absen Masuk, Setelah ada hasil fotonya tekan button "presensi"</small> </div>
                                                                            </div>
                                                                            {{-- <div class="form-group">
                                                                            ...
                                                                            <button class="btn btn-primary button-prevent"  type="submit">
                                                                                ...
                                                                                <div class="hide-text">Presensi</div>
                                                                        </button>
                                                                        </form>
                                                                    </div>
                                                        ...
                                                        @if (Carbon\Carbon::now()->between(Carbon\Carbon::parse($am->selesai), Carbon\Carbon::parse($am->mulai)))
                                                            @if (date('H:i', strtotime(now())) >= '16:30' && date('H:i', strtotime(now())) <= '19:30' && date('l', strtotime(now())) != 'Sunday' && date('l', strtotime(now())) != 'Saturday')
                                                                <th>
                                                                    <div>
                                                                        <form  class="myForm" id="form-prevent" enctype="multipart/form-data"
                                                                            action="/proses-absen-pulang-mhs/{{ $am->id }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            <div class="form-group">
                                                                                <label>Bukti Absen Masuk:</label>
                                                                ...
                                                                <th>
                                                                    <div>
                                                                        <form class="my-Form" id="formprevent" enctype="multipart/form-data"
                                                                            action="/proses-absen-izin-mhs/{{ $am->id }}"
                                                                            method="POST">
                                                                            @csrf
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            @if ($ams->file_absen != null)
                                                                <img src="{{ asset('file/absen/' . $ams->file_absen) }}" alt="Foto"
                                                                    class="img-thumbnail" width="135">
                                                            @endif
                                                        </th>
                                                        <th>{{$ams->latitude}},{{$ams->longitude}}</th>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
