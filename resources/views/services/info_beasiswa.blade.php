...
@section('kontenWebBack')
    ...
    <div class="container-fluid">
        ...
        <!-- Tombol Tambah -->
        <a href="/input-info-beasiswa" class="btn btn-primary mb-3" >Tambah Info Beasiswa Baru</a>

        <!-- DataTales E#le -->
        <div class="card Menu mb-4">
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Atur Akses Info Beasiswa</h6>
                </div>
                <div class="card-body">
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a class="btn btn-warning p-1"
                                            href="{{ url('edit-info-beasiswa/' . $d->id) }}"  onclick="return confirm('yakin Edit?');">Edit</a>
                                        <a class="btn btn-danger p-1"
                                            href="{{ url('delete-info-beasiswa/' . $d->id) }}"  onclick="return confirm('yakin Hapus?');">Hapus</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
