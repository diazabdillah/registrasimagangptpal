                        ...
                        <div class="card shadow mb-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="/edit-training/{{ $data->id }}" enctype="multipart/form-data">
                                        @method('put')
                                        @csrf
                                        <!-- Input Nama Training -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" id="fileTraining" name="fileTraining"
                                                value="{{ $data->fileTraining }}">
                                        </div>  
