...
@section('kontenWebBack')
    ...
    <div class="container-fluid">
        ...
        <!-- Tombol Tambah -->
        <a href="/input-unit-kerja" class="btn btn-primary mb-3" >Tambah Unit Kerja Baru</a>

        <!-- DataTales E#le -->
        <div class="card Menu mb-4">
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Atur Unit Kerja</h6>
                </div>
                <div class="card-body">
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a class="btn btn-warning p-1"
                                            href="{{ url('edit-unit-kerja/' . $d->id) }}"  onclick="return confirm('yakin Edit?');">Edit</a>
                                        <a class="btn btn-danger p-1"
                                            href="{{ url('delete-unit-kerja/' . $d->id) }}"  onclick="return confirm('yakin Hapus?');">Hapus</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
