        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('tambahnilai', [$user->id]) }}">
                        @csrf
                        <!-- Input Univ -->
                        ...
                        <!-- Input Strata (S1/d3) -->
                        <div class="form-group">
                            <small>Motivasi</small>
                            <input type="text" name="Motivasi" class="form-control">
                        </div>
                        <div class="form-group">
                            <small class="ml-2">Inisiatif Kerja</small>
                            <input type="text" class="form-control" id="nilai" name="InisiatifKerja">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <small class="ml-2">Etika</small>
                            <input type="text" class="form-control" id="nilai" name="etika">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <small class="ml-2">Percaya Diri</small>
                            <input type="text" class="form-control" id="nilai" name="PercayaDiri">
                        </div>
                        <div class="form-group">
                            <small class="ml-2">Tanggung Jawab Kerja</small>
                            <input type="text" class="form-control" id="nilai" name="TanggungJawab">
                        </div>
                        <div class="form-group">
