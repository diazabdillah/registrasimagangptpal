                                ...
                                @if ($users[0]->status_user == 'Mahasiswa')
                                    ...
                                    @foreach ($users as $user)
                                        <div class="col-sm-3 mb-3">
                                            <img src="{{ asset('file/foto-mhs/' . $user->foto_individu . '/' . $user->fotoID) }}"
                                ...
                                @else
                                    ...
                                    @foreach ($users as $user)
                                        <div class="col-sm-3 mb-3">
                                            ...
                                            <img src="{{ asset('file/foto-mhs-kel/' . $user->foto_individu . '/' . $user->fotoID) }}"
                                                alt="Foto" class="img-thumbnail" width="135">
                                        ...
                                        @if ($users[0]->status_user == 'Mahasiswa')
                                            @if ($img->fileinterview != null)
                                                <li class="list-group-item"><i class="fas fa-fw fa-file-pdf mr-3"></i>
                                                    {{ $img->fileinterview }}
                                                    <a target="_blank"
                                                        href="{{ asset('file/interview-mhs/' . $img->interview_individu . '/' . $img->fileinterview) }}"
                                        ...
                                        @else
                                            @if ($img->fileinterview != null)
                                                <li class="list-group-item"><i class="fas fa-fw fa-file-pdf mr-3"></i>
                                                    {{ $img->fileinterview }}
                                                    <a target="_blank"
                                                        href="{{ asset('file/interview-mhs-kel/' . $img->interview_individu . '/' . $img->fileinterview) }}"
                                                        class="badge badge-primary float-right p-2">Download <i
                                                            class="fa fa-download ml-1"></i></a>
                                                </li>
                                            @endif
                    ...
                    <div class="col-sm-12">
                        <div class="card shadow mb-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="/update-selesai-mhs/{{ $userid->id }}">
                                        @method('put')
                                        @csrf
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="custom-select" id="inputGroupSelect04" name="role_id" required>
                                                <option value="19">Magang Selesai</option>
                                                <option value="14">Magang Sertifikat</option>
