                                                ...
                                                @foreach ($users as $data)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <span
                                                                class="badge badge-danger p-2">{{ $data->status_user }}</span>
                                                        </td>
                                                        <td class="text-center">
                                                            <a class="badge badge-success p-2"
                                                                href="{{ url('ubah-magang-penuh-penelitian/' . $data->id) }}">Ubah
                                                                <i class="fas fa-user-edit ml-1"></i></a>
                                                            <a class="badge badge-danger p-2"
                                                                href="{{ url('hapus-magang-penuh-penelitian/' . $data->id) }}">Hapus
