                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($u->path != null)
                                                    <a class="btn btn-warning" href="{{ asset('file/laporan-mhs/' . $u->path) }}">Download</a>
                                                    <a class="btn btn-warning" href="{{ asset('file/laporan-mhs/' . $u->id) }}">Edit</a>
                                                    @endif
                                                </td>
                                            </tr>
                                            @endforeach
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($us->path != null)
                                                    <a class="btn btn-warning" href="{{ asset('file/laporan-smk/' . $us->path) }}">Download</a>
                                                    <a class="btn btn-warning" href="{{ asset('file/laporan-smk/' . $us->id) }}">Edit</a>
                                                    @endif
                                                </td>
                                            </tr>
                                            @endforeach
