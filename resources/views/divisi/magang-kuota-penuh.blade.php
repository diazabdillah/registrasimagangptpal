                            ...
                            <div class="card">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Magang <span
                                            class="badge badge-primary ml-2 p-1">Praktikan</span></h6>
                                </div>
                                <div class="card-body">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a class="badge badge-success p-2"
                                                                    href="{{ url('ubah-magang-penuh-mhs/' . $data->id) }}">Ubah
                                                                    <i class="fas fa-user-edit ml-1"></i></a>
                                                                <a class="badge badge-danger p-2"
                                                                    href="{{ url('hapus-magang-penuh-mhs/' . $data->id) }}">Hapus
                                                                    <i class="fas fa-user-minus ml-1"></i></a>
                                                            </td>
                                                        </tr>
                                                    @elseif($data->status_user == "SMK" || $data->status_user == "SMK
                                                        Kelompok")
                                                        <tr>
                                                            <td>{{ $no++ }}.</td>
                                                            <td>{{ $data->name }}</td>
                                                            ...
                                                            <td class="text-center">
                                                                <a class="badge badge-success p-2"
                                                                    href="{{ url('ubah-magang-penuh-smk/' . $data->id) }}">Ubah
                                                                    <i class="fas fa-user-edit ml-1"></i></a>
                                                                <a class="badge badge-danger p-2"
                                                                    href="{{ url('hapus-magang-penuh-smk/' . $data->id) }}">Hapus
                                                                    <i class="fas fa-user-minus ml-1"></i></a>
                                                            </td>
                                                        </tr>
                                                    @endif
