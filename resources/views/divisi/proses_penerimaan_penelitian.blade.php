                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card shadow mb-4">
                            <div class="card">
                                <div class="card-header">
                                    <h6 class="m-0 font-weight-bold text-primary">Berkas Calon Penelitian</h6>
                                </div>
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    @foreach ($filepdf as $file)
                                        <li class="list-group-item"><i class="fas fa-fw fa-file-pdf mr-3"></i>
                                            {{ $file->path }}
                                            <a href="{{ url('/berkas-penelitian/' . $file->id) }}"
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card">
                                <div class="card-header">
                                    <h6 class="m-0 font-weight-bold text-primary">Pilih Jurusan Penelitian
                                    </h6>
                                </div>
                                <div class="card-body">
