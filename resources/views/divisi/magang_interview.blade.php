                                                ...
                                                @foreach ($users as $u)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a class="badge badge-success p-2" href="{{ url('terima-interview-mhs/' . $u->id) }}">Detail <i class="fas fa-info-circle ml-1"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($usersSmk as $us)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a class="badge badge-success p-2" href="{{ url('final-penerimaan-smk/' . $us->user_id) }}">Detail <i class="fas fa-info-circle ml-1"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
