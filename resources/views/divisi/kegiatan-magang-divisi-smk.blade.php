    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mt-2">Form Kegiatan SMK</h5>
                        <p class="card-text"><small>Mohon para admin divisi diisi kegiatan magang untuk
                                Siswa/Siswi yang sedang melaksanakan magang di PT PAL</small>
                        </p>


                        <form method="POST" enctype="multipart/form-data" action="{{ route('tambahkegiatansmk', [$user->id]) }}">
                            @csrf
                            <!-- Input Univ -->
            ...
            <div class="col-md-7">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Daftar Kegiatan Magang SMK</h5>
                                ...
                                @foreach ($users as $u)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            href="{{ asset('delete-kegiatan-magang-smk/' . $u->id) }}">Delete</a>
                                        </td>
                                    </tr>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Hasil Kegiatan Magang SMK</h5>
