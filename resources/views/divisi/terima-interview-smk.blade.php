                                            ...
                                            @if ($img->fileinterview != null)
                                                <li class="list-group-item"><i class="fas fa-fw fa-file-pdf mr-3"></i>
                                                    ...
                                                    <a class="btn btn-danger p-1 float-right"
                                                        ...
                                                        href="{{ url('hapus-interview-smk/' . $img->id, $img->fileinterview) }}"><i
                                                            class="far fa-trash-alt p-1"></i></a>
                                                    <a class="btn btn-primary p-1 float-right"
                                                        href="{{ asset('file/interview-smk/' . $img->id_individu . '/' . $img->fileinterview) }}"><i
                                        ...
                                        @foreach ($users as $img)
                                            @if ($img->fileinterview != null)
                                                <li class="list-group-item"><i class="fas fa-fw fa-file-pdf mr-3"></i>
                                                    ...
                                                    <a class="btn btn-danger p-1 float-right"
                                                        onclick="return confirm('yakin Hapus?');"
                                                        href="{{ url('hapus-interview-smk-kel/' . $img->id, $img->fileinterview) }}"><i
                                                            class="far fa-trash-alt p-1"></i></a>
                                                    <a class="btn btn-primary p-1 float-right"
                                                        href="{{ asset('file/interview-smk-kel/' . $img->id_individu . '/' . $img->fileinterview) }}"><i
                                                            class="fa fa-download p-1"></i></a>
                                                </li>
                                            @endif
                                        @endforeach
                    ...
                    <div class="col-sm-12">
                        <div class="card shadow mb-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="/update-terima-interview-smk/{{ $userid->id }}">
                                        @method('put')
                                        @csrf
