                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card shadow mb-4">
                            <div class="card">
                                <div class="card-header">
                                    <h6 class="m-0 font-weight-bold text-primary">Pilih Divisi Magang
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="/update-magang-divisi/{{ $user->id }}">
                                        @method('put')
                                        @csrf
                        ...
                        <div class="col-sm-12">
                            <div class="card shadow mb-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="/update-magang-departemen-mhs/{{ $user->id }}">
                                            @method('put')
                                            @csrf
                                            <div class="form-group">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-info alert-dismissible fade show mt-3" role="alert">
                                        <strong>Pilih Tindakan Penerimaan</strong> berungsi untuk meneruskan proses
                                        apakah
