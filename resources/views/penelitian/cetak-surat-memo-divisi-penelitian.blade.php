...
<body>
    ...
    <div class="card-body">
        ...
        <div style="font-size: 14px;" class="justify-content-center ml-4">
            <p>Dengan Hormat,</p>
            <p style="text-align:justify;">1. Sesuai koordinasi dengan Divisi di PT. PAL Indonesia (Persero) tentang kesediaan menerima Penelitian, bersama ini disampaikan data mahasiswa/mahasiswi dari {{ $datas[0]->asal_instansi }} Jurusan {{ $datas[0]->jurusan }} yang akan melaksanakan Penelitian.
            ...
            <p style="font-size: 14px;">2.Demikian disampaikan, mohon para mahasiswa/mahasiswi tersebut diberikan arahan dan bimbingan selama melaksanakan proses Penelitian, atas bantuan dan kerja samanya diucapkan terima kasih.</p>
        </div>
