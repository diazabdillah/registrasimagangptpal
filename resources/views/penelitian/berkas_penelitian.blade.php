                        ...
                        <div class="card shadow mb-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="/proses-berkas-penelitian" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <small class="ml-2">Proposal Penelitian <small style="color: red">*Max
                                                    2MB</small></small>
                                        ...
                                        <div class="form-group">
                                            <small class="ml-2">Surat Pengajuan Penelitian <small
                                                    style="color: red">*Max
                                                    2MB</small></small>
                                            <input type="file" name="berkas[]"
                                                class="form-control @error('berkas') is-invalid @enderror">
                                        ...
                                        <div class="form-group">
                                            <small class="ml-2">Curriculum Vitae Penelitian <small
                                                    style="color: red">*Max
                                                    2MB</small></small>
                                            <input type="file" name="berkas[]"
                                                class="form-control @error('berkas') is-invalid @enderror">
