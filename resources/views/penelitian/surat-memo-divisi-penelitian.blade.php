                    ...
                    <div style="width:100%;" class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <div class="dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                    ...
                                    <a class="dropdown-item" target="_blank" href="cetak-surat-memo-divisi-penelitian">Cetak Surat Memorandum</a>
                        ...
                        <!-- Card Body -->
                                ...
                                <div class="justify-content-center ml-4" style="margin-top: 70px">
                                    <p>Dengan Hormat,</p>
                                    <p>1. Sesuai koordinasi dengan Divisi di PT. PAL Indonesia (Persero) tentang kesediaan menerima Penelitian, bersama ini disampaikan data mahasiswa/mahasiswi dari {{ $datas[0]->asal_instansi }} Jurusan {{ $datas[0]->jurusan }} yang akan melaksanakan Penelitian.
                                        Berikut ini data dari Mahasiswa/mahasiswi yang akan melakukan Penelitian&nbsp; : </p>
                                    ...
                                    <p class="ml-2">2. Demikian disampaikan, mohon para mahasiswa/mahasiswi tersebut diberikan arahan dan bimbingan selama melaksanakan proses Penelitian, atas bantuan dan kerja samanya diucapkan terima kasih.</p>
                                </div>
