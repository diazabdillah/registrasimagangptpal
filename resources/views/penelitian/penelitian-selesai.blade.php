    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div style="width:100%" class="card alert alert-success">
                ...
                <p class="text-center">Terima Kasih Telah Melaksanakan Penelitian di PT PAL Indonesia (Persero). <br>
                    Sampai
                    jumpa dan sukses selalu Good Luck Ya :).</p>
                <p class="text-center" style="font-size: small;">Sebagai Informasi : Akun anda setelah ini otomatis akan
                    dinonaktifkan</p>
