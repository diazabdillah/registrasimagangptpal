                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <form id="formregis" method="POST" action="/upload-penelitian-bpjs/{{ $user->id }}"
                                        ...
                                        @enderror
                                            ...
                                            @enderror
                                             ...
                                             <div class="form-group mt-4">
                                                ...
                                                <input type="file" class="form-control  @error('foto') is-invalid @enderror" id="asuransi" name="foto">
                                                @error('foto')
                                                <div class="invalid-feedback mt-2">
                                                    {{ $message }}
                                                </div>
