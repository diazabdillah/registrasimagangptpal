                    ...
                    <div class="card-body">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="d-flex justify-content-center">
                                    <form action="/penelitian/cari" method="GET">
                                        @csrf
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <form method="GET" action="/penelitian/cari">
                        ...
                        <div class="row mt-4">
                            @foreach ($user as $laporan)
                                @if ($laporan->status_user == 'Penelitian')
                                            ...
                                            <div class="col-md-2 mb-4">
                                                @if ($laporan->path != null)
                                                    ...
                                                    <a class="mr-4 mt-4 btn btn-primary"
                                                        href="/lihat-laporan-penelitian/{{ $laporan->id }}">lihat</a>
