...
<div class="section padding-top over-hide">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="{{URL::asset('frontend')}}/img/non-kri.png" alt="First slide">
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="list-group">
                    ...
                    <a href="non-kri" class="list-group-item list-group-item-action active">&ensp; - NON KRI</a>
            ...
            <div class="col-sm-8">
                <h1>Perbaikan & Pemeliharaan Kapal Non RI dan Non Kapal</h1>
                <p>
                    PT PAL Indonesia (Persero) sebagai Home Doctor Service untuk beberapa perusahaan pelayaran 
                    domestik maupun Off Shore untuk mendukung armada mereka dengan layanan terbaik. Dengan Tenaga 
                    kerja yang berpengalaman, terampil dan efisien, dikombinasikan dengan tenaga kerja yang efisien 
                    dan teknologi perawatan yang sangat baik, memberi pelanggan kami keunggulan harga yang kompetitif 
                    dan waktu putar balik dengan kualitas terbaik <br><br>
                </p>
            </div>
        </div>
    </div>
