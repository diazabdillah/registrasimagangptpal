...
<div class="section padding-top over-hide">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="{{URL::asset('frontend')}}/img/energy-1.png" alt="First slide">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="{{URL::asset('frontend')}}/img/energy-2.png" alt="Second slide">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="{{URL::asset('frontend')}}/img/energy-3.png" alt="Third slide">
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <a href="ship-building" class="list-group-item list-group-item-action"><b>Ship Building</b></a>
                    ...
                    <a href="energy" class="list-group-item list-group-item-action active">&ensp;- Power Plant</a>
            ...
            <div class="col-sm-8">
                <h1>Power Plant</h1>
                <p>
                    PT PAL Indonesia (Persero) mempunyai kemampuan untuk memproduksi produk rekayasa 
                    umum seperti misalnya : Merakit turbin uap sampai dengan 600 Megawatt, Kompresor 
                    modul 40 Megawatt, Barge Mounted Power Plant 30 Megawatt, Bejana tekan, pendingin 
                    dan generator, stator frame sampai dengan 600 Megawatt. <br><br>

                    Produk rekayasa lainnya yang sedang dalam proses pembangunan adalah pembangkit listrik 
                    tenaga uap, struktur jaket sampai dengan 1000 ton dan Wellhead platform sampai dengan 
                    3000 ton, Dual Fuel Barge Mounted Power Plant 60 MW & 30 MW
                </p>
            </div>
        </div>
    </div>
