        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="list-group">
                    <a href="ship-building" class="list-group-item list-group-item-action active"><b>Ship Building</b></a>
            ...
            <div class="col-sm-8">
                ...
                <p>
                    ...
                    Kualitas merupakan komitmen PT PAL Indonesia (Persero) hasil dari perencanaan yang matang dan tanggung 
                    jawab untuk selalu memberi [produk dengan kualitas terbaik. Dengan didukung oleh sumber daya manusia yang 
                    profesional dan berpengalaman, sistem manajemen modern dan teknologi canggih, kami menjadi produsen kapal 
                    maupun rekayasa umum terbesar dan terbaik di Indonesia. <br><br>
                </p>
            </div>
        </div>
    </div>
