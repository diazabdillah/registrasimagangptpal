...
<div class="section padding-top over-hide">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="{{URL::asset('frontend')}}/img/kri.png" alt="First slide">
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="list-group">
                    ...
                    <a href="kri" class="list-group-item list-group-item-action active">&ensp; - KRI</a>
            ...
            <div class="col-sm-8">
                <h1>Perbaikan & Pemeliharaan Kapal RI</h1>
                <p>
                    PT PAL Indonesia (Persero) telah melaksanakan fungsi Pemeliharaan dan Perbaikan KRI milik TNI AL. 
                    Divisi ini telah melakukan perawatan rutin hingga overhaul untuk semua jenis kapal Angkatan Laut, 
                    Kapal Permukaan dan Kapal Selam. <br><br>

                    Sesuai pasal 11, Undang Undang No 16 Tahun 2012 ; PT PAL Indonesia (Persero) merupakan Industri 
                    Utama Pertahanan / Industri Utama Pembuat Sistem Senjata adalah perusahaan milik negara yang ditentukan 
                    oleh pemerintah sebagai lead integrator yang menghasilkan sistem utama senjata atau mengintegrasikan 
                    komponen utama, komponen, dan bahan baku menjadi sistem senjata siap pakai. <br><br>
                </p>
            </div>
        </div>
    </div>
